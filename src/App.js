...
function App() {
	...
	const columns = [
		...
		{id: uuid(), key: 'income', label: 'Income', isSearchable: true},
		...
		{id: uuid(), key: 'accountBalance', label: 'Account Balance', isSearchable: true},
		{id: uuid(), key: 'numOfAccount', label: 'Total Accounts', isSearchable: false},
		{id: uuid(), key: 'accountType', label: 'Type of Account', isSearchable: true},
...
// The filtering criteria should be >=, <=, and, Or between, contains

// 4.Categorical filtering should be attainable by using multi-select dropdowns/Radio button/checkbox etc.
